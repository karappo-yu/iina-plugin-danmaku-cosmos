...
[data-dm-css-container] {
  ...
  --dm-voffset: 5;
  transform: translateY(calc(var(--dm-voffset) * var(--dm-unit)));
  pointer-events: none;
  overflow: hidden;
  z-index: 1;
...
`;
	var CSSRenderer = class {
		...
		createCommentElement(comment, vpos, frameActiveState) {
			...
			let posY;
			if (comment.loc === "shita") posY = config.canvasHeight - comment.posY - lineHeightPx * c.lineCount;
			...
			element.style.paddingTop = `calc(${paddingTopCanvas} * var(--dm-unit))`;
