...
`;
	var CSSRenderer = class {
		...
		createCommentElement(comment, vpos, frameActiveState) {
			...
			const fontOffset = ((_config$fonts$html5$c = config.fonts.html5[c.font]) === null || _config$fonts$html5$c === void 0 ? void 0 : _config$fonts$html5$c.offset) || 0;
