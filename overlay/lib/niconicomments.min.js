	...
	var CSSRenderer = class {
		...
		updateComments(comments, vpos, frameActiveState) {
			...
			for (let i = startIndex; i < endIndex; i++) {
				...
				else if (isSeek) this.setupFixedAnimation(element, this.getEffectiveAlpha(comment.comment));
				drawnCount++;
			}
			this.lastUpdateVpos = vpos;
		...
		createCommentElement(comment, vpos, isReverse) {
			...
			} else this.setupFixedAnimation(element, effectiveAlpha);
		...
		setupFixedAnimation(element, effectiveAlpha) {
