...
1. プラグインファイルをダウンロード
2. IINA → 設定 → プラグイン → プラグインを追加 でフォルダを選択
3. IINA を再起動
...
2. Open IINA → Preferences → Plugins → Add Plugin, select the plugin folder
3. Restart IINA
